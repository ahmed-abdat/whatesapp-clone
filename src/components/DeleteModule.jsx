  ...
  return (
    <div className="module d-f">
      <div className="module--container">
        ...
        <div className="btns">
          <button className="btn btn--cancel f-ar" onClick={handelCancel}>لا , إلغاء</button>
          <button className="btn btn--delete f-ar" onClick={handelDelete}> {deleteBtnText} </button>
        </div>
      </div>
    </div>
  );
